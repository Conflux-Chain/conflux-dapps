...
import APPConsumer from './Consumer/APP';
        ...
        <ScrollToTop>
            <Card>
                <Routes>
                    ...
                    <Route path="/provider/app/:address" element={<APPProvider />} />
                    <Route path="/provider/app/:type/:address" element={<APPProvider />} />
                    ...
                    <Route path="/consumer/app/:type/:address" element={<APPConsumer />} />
                    <Route path="*" element={<Navigate to="provider/apps" />} />
                </Routes>
                <Outlet />
            </Card>
