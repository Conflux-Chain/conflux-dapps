    ...
    <div className="mt-8 px-8 bg-transparent flex flex-col justify-center items-center w-full">
      ...
      {!isMobile && (
        <div className="flex items-center flex-col mt-8 text-gray-80">
          ...
          <ThemeButton />
          <LanguageButton /> */}
          <span id="title" className="text-2xl">ZERO GRAVITY</span>
          <span className="text-base leading-5 inline-block mt-7 opacity-70">Make a fast and secure transaction</span>
        </div>
      )}
    </div>
  )
