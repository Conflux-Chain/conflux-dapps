                        ...
                        <Input
                            ...
                            outerPlaceholder={
                                <div className="input-placeholder text-[14px]">
                                    <span className="font-semibold text-[#15C184]">Conflux eSpace</span>{' '}
                                    <span className="text-[#979797]">Destination Address</span>
                                </div>
                            }
    ...
    return (
        <>
            ...
            <div className="text-[14px] leading-[18px] text-[#3D3F4C]">
                <span className="text-[#2959B4]" id="core-balance">
                    Core
                </span>{' '}
                Balance:
                <BalanceText
