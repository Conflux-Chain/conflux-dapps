import { store as fluentStore, Unit } from '@cfxjs/use-wallet-react/conflux/Fluent';
import { sendTransaction as sendTransactionWithMetaMask } from '@cfx-kit/react-utils/dist/AccountManage';
