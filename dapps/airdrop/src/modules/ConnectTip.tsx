...
const ConnectTip: React.FC = () => {
    ...
    return (
        <div className="mt-[52px]">
            <div className="mb-[12px] flex items-center h-[24px] text-[16px] text-[#3D3F4C] font-medium">
            ...
            <div className="mt-[28px] mb-[12px] flex items-center h-[24px] text-[16px] text-[#3D3F4C] font-medium">
