...
import { useCrossNetwork, useESpaceNetwork, setCurrentFromChain } from 'espace-bridge/src/store';
...
const ChainSelect: React.FC = () => {
    ...
    const [flipped, setFlipped] = useState(() => {
        const res = LocalStorage.get('flipped', 'espace-bridge') === true;
    ...
    const handleClickFlipped = useCallback(() => {
        setFlipped((pre) => {
            LocalStorage.set('flipped', !pre, 0, 'espace-bridge');
