...
} from 'etc-espace/src/store';
import PoolIcon from 'etc-espace/src/assets/pool.svg';
import YouSHareIcon from 'etc-espace/src/assets/you-share.svg';
import RedeemableIcon from 'etc-espace/src/assets/redeemable.svg';
