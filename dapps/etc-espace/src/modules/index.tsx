...
import { startSub, useHasPeggedCFX } from 'etc-espace/src/store';
import Send from 'etc-espace/src/modules/Send';
import Claim from 'etc-espace/src/modules/Claim';
import Redeem from 'etc-espace/src/modules/Redeem';
import LocalStorage from 'localstorage-enhance';
import './index.css';

const transitions = {
    en: {
        transfer_assets: 'CFX/ETC Cross-chain',
        between_space: 'Between Ethereum Classic and Conflux eSpace.',
    },
    zh: {
        transfer_assets: 'CFX/ETC 跨链',
        between_space: '在 Ethereum Classic 和 Conflux eSpace 之间。',
    },
} as const;
