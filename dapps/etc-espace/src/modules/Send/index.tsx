...
import { useBalance, useMaxAvailableBalance, useNeedApprove, useToken, useCurrentFromNetwork, useCurrentToNetwork, setTransferBalance, useIsTransferHasEnoughLiquidity } from 'etc-espace/src/store';
import useI18n from 'common/hooks/useI18n';
import Input from 'common/components/Input';
import Button from 'common/components/Button';
import { AuthEthereum } from 'common/modules/AuthConnectButton';
import BalanceText from 'common/modules/BalanceText';
import TokenList from 'etc-espace/src/components/TokenList';
...
const Form: React.FC = () => {
    ...
    return (
        <form onSubmit={onSubmit}>
			...
			<div className="text-[14px] leading-[18px] text-[#3D3F4C] whitespace-nowrap">
			...
			{isTransferHasEnoughLiquidity &&
				<div className="mt-[20px] text-[14px] leading-[18px] text-[#3D3F4C] whitespace-nowrap">
